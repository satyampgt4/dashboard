    ...
    let milestones = [
        {
            ...
            milestoneProgressPercentage: clamp((((completedQuestBadges>10?10:completedQuestBadges) / 10) + ((completedSkillBadges>5?5:completedSkillBadges) / 5)) * 50, 0, 100).toFixed(2),
            maxQuestBadges: 10,
            maxSkillBadges: 5,
        ...
        },
        {
            ...
            milestoneProgressPercentage: clamp((((completedQuestBadges>20?20:completedQuestBadges) / 20) + ((completedSkillBadges>10?10:completedSkillBadges) / 10)) * 50, 0, 100).toFixed(2),
            maxQuestBadges: 20,
            maxSkillBadges: 10,
        ...
        },
        {
            ...
            milestoneProgressPercentage: clamp((((completedQuestBadges>30?30:completedQuestBadges) / 30) + ((completedSkillBadges>15?15:completedSkillBadges) / 15)) * 50, 0, 100).toFixed(2),
            maxQuestBadges: 30,
            maxSkillBadges: 15,
        ...
        {
            milestoneTitle: "Ultimate Milestone: Complete any 30 quests & 15 skill badges + 6 other quests/skill badges in the program",
